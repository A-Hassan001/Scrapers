...
#         'FEEDS': {
#             'output/simply_recipes_dinner.csv': {
#                 'format': 'csv',
#                 'overwrite': True,
#                 'encoding': 'utf8',
#             }
...
#         start_url = 'https://www.simplyrecipes.com/dinner-recipes-5091433'
...
class DinnerSpider(BaseRecipesSpider):
    name = "dinner"
    start_url = 'https://www.simplyrecipes.com/dinner-recipes-5091433'
    max_categories = ['https://www.simplyrecipes.com/comfort-food-recipes-5091432',
