...
#         'FEEDS': {
#             'output/simply_recipes_lunch.csv': {
#                 'format': 'csv',
#                 'overwrite': True,
#                 'encoding': 'utf8',
#             }
...
#         start_url = 'https://www.simplyrecipes.com/lunch-recipes-5091263'
#         yield Request(url=start_url, headers=self.headers, callback=self.parse)
#
#     def parse(self, response, **kwargs):
#         yield from self.parse_recipe_listing(response)
#         category_links = response.css('div.mntl-taxonomysc-child-block__links a::attr(href)').getall()[:4]
#
...
class LunchSpider(BaseRecipesSpider):
    name = "lunch"
    start_url = 'https://www.simplyrecipes.com/lunch-recipes-5091263'
    max_categories = ['https://www.simplyrecipes.com/sandwich-recipes-5091260',
