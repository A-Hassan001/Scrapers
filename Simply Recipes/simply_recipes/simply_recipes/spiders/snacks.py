...
#         'FEEDS': {
#             'output/simply_recipes_snacks.csv': {
#                 'format': 'csv',
#                 'overwrite': True,
#                 'encoding': 'utf8',
#             }
...
#         start_url = 'https://www.simplyrecipes.com/snacks-and-appetizer-recipes-5090762'
...
class SnacksSpider(BaseRecipesSpider):
    name = "snacks"
    start_url = 'https://www.simplyrecipes.com/snacks-and-appetizer-recipes-5090762'
    max_categories = ['https://www.simplyrecipes.com/dip-recipes-5090764',
