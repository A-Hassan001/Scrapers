...
#         'FEEDS': {
#             'output/simply_recipes_dessert.csv': {
#                 'format': 'csv',
#                 'overwrite': True,
#                 'encoding': 'utf8',
#             }
...
#         start_url = 'https://www.simplyrecipes.com/dessert-recipes-5091513'
...
class DessertSpider(BaseRecipesSpider):
    name = "dessert"
    start_url = 'https://www.simplyrecipes.com/dessert-recipes-5091513'
    max_categories = ['https://www.simplyrecipes.com/dessert-recipes-by-type-5091493',
